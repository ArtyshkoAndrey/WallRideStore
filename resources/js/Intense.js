let Intense;
export default Intense = (function() {
  ...
  function createViewer( title, caption ) {
    ...
    let idCloseButton = 'close-big-image-slider';
    let closeButtonProperties = {
    ...
    closeButton.setAttribute("id", idCloseButton);
    container.appendChild( closeButton );
    applyProperties( closeButton, closeButtonProperties );
    /*
     *  Caption Container
     */
    var captionContainerProperties = {
      'font': '18px/27px "Circe", sans-serif',
      'position': 'fixed',
      'bottom': '0px',
      'left': '0px',
      'padding': '20px',
  ...
  function bindEvents() {
    ...
    document.getElementById('close-big-image-slider').addEventListener(    'click',     removeViewer,  false );
  }
  ...
  function unbindEvents() {
    ...
    document.getElementById('close-big-image-slider').removeEventListener(    'click',     removeViewer,  false )
  }
