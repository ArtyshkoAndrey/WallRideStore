  ...
  <div class="container-fluid mt-20 mb-20">
    <div class="row row-eq-spacing">
      ...
      <div class="col-12 p-0">
        <form action="{{ route('admin.post.store') }}" method="POST" class="w-full">
          @csrf
                    ...
                    <div class="wrapper-tabs">
                      ...
                      <div class="tabs-content active" id="russian">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="ru[title]" id="ru_title" placeholder="Название" value="{{ old('ru.title') }}" required>
                        </div>
                      ...
                      <div class="tabs-content" id="english">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="en[title]" id="en_title" placeholder="Название" value="{{ old('en.title') }}" required>
                        </div>
...
@section('script')
  ...
  <script>
    ...
    $(document).ready(() => {
      ...
      let mockFile
      @if (old('photo'))
        mockFile = { name: '{{ old('photo') }}', size: {{ File::size(public_path(\App\Models\Post::PHOTO_PATH . old('photo') . '.jpg')) }} };
        uploader.emit("addedfile", mockFile);
        uploader.emit("thumbnail", mockFile, '{{ asset(\App\Models\Post::PHOTO_PATH . old('photo') . '.jpg') }}');
