    ...
    <div class="row row-eq-spacing justify-content-center">
      <div class="col-12">
        <nav aria-label="Breadcrumb navigation example">
          <ul class="breadcrumb">
            <li class="breadcrumb-item active"><a href="#">Новости</a></li>
      ...
      <div class="col-12">
        <div class="row align-items-center">
          ...
          <div class="col-md-auto col-12 mt-10 mt-md-0 px-10">
            <a href="{{ route('admin.post.create') }}" class="btn d-block">Создать новую новость</a>
          </div>
      ...
      <div class="col-md-auto mt-10 col-auto">
        <a href="{{ route('admin.post.index') }}" class="btn">Сбросить</a>
      </div>
              ...
              <div class="card p-10 bg-dark-dm m-0">
                <div class="row align-items-center">
                  <div class="col-auto col-md-auto">
                    <a href="{{ route('admin.post.edit', $post) }}" class="text-decoration-none m-0 p-0 text-danger">
                      <h5 class="p-0 m-0 d-block">{{ $post->title }}</h5>
                    </a>
                  </div>
                  ...
                  <div class="col-lg col-12">
                    <div class="row justify-content-end">
                      <div class="col-md-auto col-6 pl-10 mt-10 mt-lg-0 mt-md-10">
                        <a href="{{ route('admin.post.edit', $post) }}" class="btn bg-transparent text-success shadow-none border-0 d-block"><i class="bx bx-pencil font-size-16"></i></a>
                      </div>
                      <div class="col-md-auto col-6 pl-10 mt-10 mt-lg-0 mt-md-10">
