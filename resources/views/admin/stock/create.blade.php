              ...
              <div class="col-md-12">
                ...
                <div class="row">
                  <div class="col-md-4">
                    ...
                    <input name="delay" id="delay" type="number" class="w-100 px-2 form-control rounded-0 {{ $errors->has('delay') ? ' is-invalid' : '' }}" value="{{ old('delay') }}">
                    <span id="delay-error" class="error invalid-feedback">{{ $errors->first('delay') }}</span>
                  </div>

                  <div class="col-md-12 mt-2 mb-2">
                    <input name="on_auth" type="checkbox" id="on_auth" class="p-5 rounded-0 {{ $errors->has('on_auth') ? ' is-invalid' : '' }}" @if(old('on_auth')) checked @endif>
                ...
                <div class="row">
                  <div class="col-md-8" id="checker_images">
                    ...
                    <ul>
                      ...
                      <li><input type="radio" name="view" value="3" id="cb3" {{ old('view') === 3 ? 'checked' : '' }} />
