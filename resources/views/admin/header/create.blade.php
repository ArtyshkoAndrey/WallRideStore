    ...
    <div class="row mt-0 pt-0">
      <div class="card border-0 w-100 rounded-0" style="z-index: 90;box-shadow: 0 18px 19px rgba(0, 0, 0, 0.25)">
        <div class="card-body">
              ...
              <div class="col-md-12">
                <div class="row">
                  <div class="col-md-8">
                    ...
                    <input type="text" name="h1" id="h1" class="w-100 px-2 form-control rounded-0 {{ $errors->has('h1') ? ' is-invalid' : '' }}" value="{{ old('h1') ? old('h1') : '' }}" required>
                ...
                <div class="row">
                  <div class="col-md-8">
                    ...
                    <input type="text" name="h2" id="h2" class="w-100 px-2 form-control rounded-0 {{ $errors->has('h2') ? ' is-invalid' : '' }}" value="{{ old('h2') ? old('h2') : '' }}" required>
                ...
                <div class="row">
                  <div class="col-md-8">
                    ...
                    <input type="text" name="url" id="url" class="w-100 px-2 form-control rounded-0 {{ $errors->has('url') ? ' is-invalid' : '' }}" value="{{ old('url') ? old('url') : '' }}" required>
                ...
                <div class="row">
                  <div class="col-md-8">
                    ...
                    <input type="text" name="btn_text" id="btn_text" class="w-100 px-2 form-control rounded-0 {{ $errors->has('btn_text') ? ' is-invalid' : '' }}" value="{{ old('btn_text') ? old('btn_text') : '' }}" required>
          ...
          <div class="row mt-3">
            <div class="col-md-8">
              <form id="upload-widget" method="post" action="{{route('admin.header.photoCreate')}}" class="dropzone"></form>
            </div>
          </div>
        </div>
      </div>
...
@section('js')
  ...
  <script !src="">
    ...
    const uploader = new Dropzone('#upload-widget', {
      ...
      init: function() {
        ...
        this.on("removedfile", function(file) {
          ...
          if (rmvFile){
            console.log(rmvFile)
            axios.post("{{route('admin.header.photoDelete')}}", {
              name: rmvFile,
            })
              .then(response => {
      ...
      acceptedFiles: 'image/*',
      url: "{{route('admin.header.photoCreate')}}",
    ...
    @if(old('photo'))
      ...
      uploader.emit("thumbnail", mockFile, '{{ asset('storage/header/') . '/' . old('photo') }}');
