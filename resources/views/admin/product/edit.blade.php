                    ...
                    <div class="wrapper-tabs">
                      ...
                      <div class="tabs-content active" id="russian">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="ru[title]" id="title" placeholder="Название" value="{{ old('ru.title', $product->{'title:ru'}) }}" required>
                        </div>

                        <div class="form-group">
                          <label for="ru_description" class="required">Описание</label>
                          <textarea class="form-control" name="ru[description]" id="ru_description" cols="30" rows="20">{{ old('ru.description', $product->{'description:ru'}) }}</textarea>
                        </div>
                      ...
                      <div class="tabs-content" id="english">
                        ...
                        <div class="form-group">
                          <label for="title" class="required">Название</label>
                          <input type="text" class="form-control" name="en[title]" id="title" placeholder="Название" value="{{ old('en.title', $product->{'title:en'}) }}" required>
                        </div>

                        <div class="form-group">
                          <label for="en_description" class="required">Описание</label>
                          <textarea class="form-control" name="en[description]" id="en_description" cols="30" rows="20">{{ old('en.description', $product->{'description:en'}) }}</textarea>
                        </div>
