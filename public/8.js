...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    ...
    var cells = $('#' + this.nameid + ' .carousel-cell');
    var flickityViewport = $('#' + this.nameid + ' div.flickity-viewport');
    var cards = $('#' + this.nameid + " div.carousel-cell .card");
    $(window).resize(function () {
      cells.height('auto');
    });
    setInterval(function () {
      cells.height('auto');
      _this.maxHeight = Math.max.apply(null, cards.map(function () {
        return $(this).height();
      }).get());
      flickityViewport.height(_this.maxHeight + 20);
      cells.height(_this.maxHeight);
    }, 100);
  }
});
