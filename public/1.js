...
/* harmony default export */ __webpack_exports__["default"] = ({
  name: "product-list",
  components: { carousel: __WEBPACK_IMPORTED_MODULE_0_vue_owl_carousel___default.a, product: __WEBPACK_IMPORTED_MODULE_1__product___default.a },
  data: function data() {
    return {};
  },
    ...
    addToCart: function addToCart() {
      ...
      if (this.count > 0) {
        axios.post('/cart', {
          ...
          swal('Товар добавлен в корзину', '', 'success').then(function () {
            _this.cart = true;
            setTimeout(function () {
              _this.cart = false;
            }, 2000);
          ...
          if (_this.slider) {
            _this.$parent.$parent.$parent.cartItems = data.cartItems;
            _this.$parent.$parent.$parent.priceAmount = data.priceAmount;
            _this.$parent.$parent.$parent.amount = data.amount;
          } else {
    ...
    [
      _c("div", { class: _vm.slider ? "card" : "card h-100" }, [
        _c(
          ...
          {
            staticClass:
              "card-body px-0 pb-0 justify-content-between d-flex flex-column"
          },
          [
            _c("div", [
              ...
              _c(
                ...
                [
                  _vm._v(
                    _vm._s(
                      _vm.item.title.length > 30
                        ? _vm.item.title.slice(0, 30) + "..."
                        : _vm.item.title
                    )
                  )
                ]
            ...
            _c("div", { staticClass: "row px-0 mx-0" }, [
              ...
              _vm._v(" "),
              _c("div", { staticClass: "col-4 px-0" }, [
                _c("div", { staticClass: "row h-100 m-0" }, [
                  _c("div", { staticClass: "col-7 m-0 p-0" }, [
                    _c("input", {
                      directives: [
                        {
                          name: "model",
                      ...
                      staticClass:
                        "form-control w-100 bg-white h-100 border-0 p-0 font-weight-bolder text-center",
                      staticStyle: {
                        "font-size": "16px",
                        "line-height": "24px"
                      },
                  ...
                  _vm._v(" "),
                  _c("div", { staticClass: "col-4 px-0" }, [
                    _c("div", { staticClass: "row p-0 m-0 h-100" }, [
                      _c(
                        "div",
                        {
                          staticClass:
                            "col-12 p-0 w-100 d-flex justify-content-center align-items-center"
                        },
                        [
                          _c(
                            "button",
              ...
              _c("div", { staticClass: "col-4 pr-0 pl-1" }, [
                _c("div", { staticClass: "row h-100 m-0" }, [
                  _c("div", { staticClass: "col-2 pl-0 pr-1" }, [
                    _c(
                      "button",
                      {
                        ...
                        staticClass:
                          "btn p-0 m-0 bg-transparent btn-angle h-100",
                  ...
                  _vm._v(" "),
                  _c("div", { staticClass: "col-6 m-0 h-100 pl-1 pr-0" }, [
                    _c("input", {
                      directives: [
                        {
                          name: "model",
                      ...
                      staticClass:
                        "form-control w-100 bg-white border-0 h-100 px-0 font-weight-bolder text-center",
